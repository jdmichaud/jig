...
pub fn create_executable_and_run_step(b: *std.Build, target: std.Build.ResolvedTarget,
    ...
    libreadline_dep: *std.Build.Dependency) void {
...
pub fn build(b: *std.Build) void {
    ...
    create_executable_and_run_step(b, target, optimize, "json", "src/json.zig", mod, jam, readline_dep, libreadline_dep);
    create_executable_and_run_step(b, target, optimize, "interpreter", "src/interpreter.zig", mod, jam, readline_dep, libreadline_dep);
